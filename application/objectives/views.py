...
def add_objective():
    ...
    if form.validate_on_submit():
        ...
        return render_template('objectives/add-edit-objective.html', form=form, url=add_url)
...
def edit_objective(id):
    ...
    if form.validate_on_submit():
        ...
        return render_template('objectives/add-edit-objective.html', form=form, url=edit_url, edit=True)
